...
void lcd_init_hw(lcd* plcd)
{
    ...
    case LCD_0_96_INCH:
      ...
      lcd_config_reg(plcd->io, 0xE0, 0x07, 0x0E, 0x08, 0x07, 0x10, 0x07, 0x02,
                     0x07, 0x09, 0x0F, 0x25, 0x36, 0x00, 0x08, 0x04, 0x10);
      /* Negative Voltage Gamma Control */
      lcd_config_reg(plcd->io, 0xE1, 0x0A, 0x0D, 0x08, 0x07, 0x0F, 0x07, 0x02,
                     0x07, 0x09, 0x0F, 0x25, 0x35, 0x00, 0x09, 0x04, 0x10);
      break;
    case LCD_1_14_INCH:
      /* Positive Voltage Gamma Control */
      lcd_config_reg(plcd->io, 0xE0, 0xD0, 0x04, 0x0D, 0x11, 0x13, 0x2B, 0x3F,
                     0x54, 0x4C, 0x18, 0x0D, 0x0B, 0x1F, 0x23);
      /* Negative Voltage Gamma Control */
      lcd_config_reg(plcd->io, 0xE1, 0xD0, 0x04, 0x0C, 0x11, 0x13, 0x2C, 0x3F,
                     0x44, 0x51, 0x2F, 0x1F, 0x1F, 0x20, 0x23);
      break;
    case LCD_1_47_INCH:
      /* Positive Voltage Gamma Control */
      lcd_config_reg(plcd->io, 0xE0, 0xF0, 0x00, 0x04, 0x04, 0x04, 0x05, 0x29,
                     0x33, 0x3E, 0x38, 0x12, 0x12, 0x28, 0x30);
      /* Negative Voltage Gamma Control */
      lcd_config_reg(plcd->io, 0xE1, 0xF0, 0x07, 0x0A, 0x0D, 0x0B, 0x07, 0x28,
